...
[麦麦笔记本](https://maimainp.stmfanserver.xyz)是一款由**非麦麦官方**搭建的LPMM知识库分享站。你可以在这里上传你自己的知识库，也可以下载别人上传的知识库。**入站请阅读 公告中心 的“入站须知”**

目前“麦麦笔记本”处于测试阶段，且正考虑是否组建一个开发团队，如果您有一定的Vite前端网页开发/面向AI编程基础，或者您有意向帮助站主审核知识库。欢迎联系*STMfan(QQ:3626599388)*。站主诚挚欢迎每一位加入“麦麦笔记本”的贡献者！

::: warning 警告
**由于“麦麦笔记本”的非官方属性，请不要将任何“麦麦知识库”的Bug与问题反馈到官方渠道！！**
